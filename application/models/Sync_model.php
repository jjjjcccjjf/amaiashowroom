...
class Sync_model extends Crud_model
{
  public function __construct()
  {
    ...
    $this->questions = [
      ...
      'specific_occupation' => 'Specific occupation / nature of business',
      'current_residence' => 'Current residence',
      'specific_residence' => 'Specific residence',
      'work_location' => 'Work location',
      'specific_work_location' => 'Specific work location',
  ...
  public function add($data)
  {
    ...
    return $this->feedback_model->add([
      ...
      'generated_code' => @$data->meta->generated_code,
    ]);
  }
